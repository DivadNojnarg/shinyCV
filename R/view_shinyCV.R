...
#' generated as in the example of feed_shinyCV(). If the data_source is build_shinyCV()
#' (the corresponding argument is set to "from_cvbuilder"),
#' datas are generated by filling the forms in the dedicated interface
#' (see build_shinyCV()).
...
#' the list of datas returned by the feed_shinyCV function.
#'
#' @export
#' @examples
#'
